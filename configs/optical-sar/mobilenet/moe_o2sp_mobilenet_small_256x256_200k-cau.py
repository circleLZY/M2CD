_base_ = [
    '/home/lzy/proj/rmcd-kd/configs/_base_/models/mobilenet/moe_o2sp_mobilenet_small.py',
    '/home/lzy/proj/rmcd-kd/configs/common/standard_256x256_200k_cau.py']

crop_size = (256, 256)
checkpoint = 'https://download.openmmlab.com/mmclassification/v0/mobilenet_v3/mobilenet-v3-small_8xb128_in1k_20221114-bd1bfcde.pth'  # noqa
