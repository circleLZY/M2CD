...
@MODELS.register_module()
class MultiTeacherCDPreProcessor(DualInputSegDataPreProcessor):
    def __init__(
        self,
        mean: Sequence[Number] = None,
        std: Sequence[Number] = None,
        ...
        if training:
            ...
            for data in data:
                ...
                for i in range(len(data['inputs'])):
                    inputs.append(data['inputs'][i])
                    if data.get('data_samples', None):
                        data_samples.append(data['data_samples'][i])
